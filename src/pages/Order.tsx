...
function Order() {
    return (
        <div className={"container pt-5"}>
            <div className="card cs-card cs-box-shadow p-4 border-0 ">
                    <h5 className="fs-20px fw-700 text-cs-black">Order</h5>
                <div className="card-body">
                    <table className="table align-middle table-row-dashed fs-14px">
